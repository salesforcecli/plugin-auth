...
Logging in to a business or production org is not recommended on a demo or shared machine. Please run "sfdx auth:logout --targetusername <your username> --noprompt" when finished using this org, which is similar to logging out of the org in the browser.
